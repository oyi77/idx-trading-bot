...
class BotHandlers:
    ...
    async def start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        text = (
            ...
            "• /backtest — validasi performa 3 tahun\n"
    ...
    async def panduan(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        text = (
            ...
            "• /backtest — Validasi performa 3 tahun kebelakang. Lihat win rate, "
            "max drawdown, profit factor, dan distribusi return.\n"
            "   _Contoh: /backtest TLKM_\n\n"
