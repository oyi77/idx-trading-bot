...
COMMANDS = [
    ...
    ("analisa", "🔍 Analisa saham [symbol] — ex: analisa BBCA"),
    ("stats", "📊 Statistik saham [symbol]"),
    ("briefing", "☀️ Daily AI market briefing"),
    ("premarket", "🌅 Pre-market snapshot — global + IDX"),
    ("news", "📰 Berita saham terkini [symbol]"),
    ("trending", "📈 Top gainers & losers momentum"),
    ("breadth", "📐 Market breadth — A/D ratio"),
    ("calendar", "📅 Kalender ekonomi minggu ini"),
    ("ihsg", "🏛️ Data IHSG real-time"),
    ...
    ("screener_breakout", "💥 Saham breakout level kunci"),
    ("screener_smartmoney", "🏦 Jejak akumulasi bandar"),
    ("plan", "📋 Trading plan [symbol] [entry] [sl] [tp]"),
    ("alert", "🔔 Harga alert [symbol] [>,<] [target]"),
    ("portfolio", "💼 Portfolio — add/close/status"),
    ("portfolio add", "➕ Tambah posisi [symbol] [price] [lot]"),
    ("portfolio close", "❌ Tutup posisi [symbol] [price]"),
    ...
    ("upgrade", "⬆️ Upgrade ke Pro/Premium"),
