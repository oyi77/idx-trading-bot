...
try:
    ...
    "ALDO","ALII","ALKA","ALLY","AMAG","AMAN","AMAR","AMIN","AMMN","AMMS","AMOR",
    "AMRT","ANAB","ANDI","ANJT","ANTM","APEX","APIC","APII","APLN","ARCI","ARGO",
    "ARKO","ARMY","ARNA","ARTI","ASBI","ASDM","ASGR","ASHA","ASII","ASLI","ASPI",
    "ASRI","ASSY","ATAP","ATIC","AUTO","AYAM","AYLS","BABY","BACA","BAIK","BALI",
    "BANK","BAPA","BAPI","BATA","BATR","BAUT","BAYU","BBCA","BBHI","BBIA","BBNI",
    "BBRI","BBRM","BBSS","BBTN","BBYB","BCAP","BCIC","BCIP","BDMN","BEBS","BEEF",
    "BEER","BEKS","BELI","BESS","BEST","BHAT","BHIT","BIKA","BIMA","BINO","BIPI",
    "BIRD","BISI","BJBR","BJTM","BKDP","BKSL","BLTA","BLTZ","BLUE","BMAS","BMHS",
    "BMRI","BMTR","BNBA","BNBR","BNGA","BNII","BOLT","BOSS","BPII","BRAM","BREN",
    "BRIS","BRMS","BRPT","BSDE","BSIM","BSSR","BTEL","BTON","BTPN","BTPS","BUDI",
    "BUKA","BUKK","BULL","BUNT","BVA","BVIC","BWPT","BYAN","CAKK","CAMP","CANI",
    "CARE","CASA","CASH","CASS","CBMF","CBPE","CBUT","CCSI","CEKA","CENT","CFIN",
    "CHEM","CHIP","CINT","CITA","CITY","CLAY","CLEO","CLPI","CMNT","CMPP","CNKO",
    "CNMA","CNTX","COAL","COCO","COWL","CPIN","CPRI","CPRO","CRAB","CRSN","CSAP",
    "CSIS","CSMI","CSRA","CTBN","CUAN","CYBR","DADA","DAMN","DART","DAYA","DCII",
    "DEAL","DEEP","DEFI","DEWI","DFAM","DGIK","DGLY","DGWG","DILD","DIVA","DKFT",
    "DLTA","DMAS","DMMX","DMND","DNAR","DNET","DOID","DOSS","DPNS","DPUM","DSFI",
    "DSNG","DSSA","DUCK","DUTI","DVLA","DWGL","DYAN","EAST","ECII","EDGE","EGMS",
    "EKAD","ELIT","ELPI","ELSA","EMDE","EMTK","ENAK","ENRG","ENT","EPAC","EPMT",
    "ERAA","ERTX","ESIP","ESSA","ESTA","ESTI","ETWA","EXCL","FAST","FASW","FILM",
    "FIRE","FISH","FITT","FLMC","FMII","FOLK","FOOD","FORU","FORZ","FPNI","FREN",
    "FUJI","FUTR","FWCT","GAMA","GDYR","GDST","GEMA","GEMS","GGRM","GGRP","GHON",
    "GIAA","GJTL","GLVA","GMTD","GOLD","GOLL","GOLF","GOOD","GPG","GPRA","GPSO",
    "GRIA","GRPH","GSMF","GTBO","GTSI","GULA","GZCO","HADE","HALO","HATM","HAWK",
    "HDIT","HDTX","HEAL","HELI","HERO","HEXA","HILL","HITS","HMSP","HOMI","HOPE",
    "HOTL","HRME","HRTA","HRUM","IATA","IBFN","IBST","ICBP","ICON","IDPR","IFII",
    "IGAR","IIKP","IKAI","IMAS","IMJS","IMPC","INAF","INAI","INCF","INCI","INCO",
    "INDR","INDS","INDX","INDY","INKP","INOV","INPC","INPP","INPS","INTD","INTP",
    "IPAC","IPCM","IPOL","IPPE","IRRA","ISAP","ISAT","ITIC","ITMA","ITMG","JAST",
    "JATI","JAYA","JECC","JGLE","JIHD","JKON","JKSW","JMAS","JPFA","JRPT","JSKY",
    "JSMR","JSPT","JTPE","KAEF","KARW","KAYU","KBAG","KBLI","KBLM","KBRI","KDSI",
    "KDTN","KEEN","KEJU","KIAS","KICI","KIJA","KING","KINO","KJEN","KKES","KLAS",
    "KLBF","KMDS","KMTR","KOCI","KOIN","KOKA","KONI","KOPI","KOTA","KPAL","KPAS",
    "KPIG","KRYA","KUAS","LABA","LAND","LAPD","LAJU","LCGP","LCKM","LEBA","LIFE",
    "LIMP","LINK","LION","LMAS","LMPI","LMSH","LNV","LPCK","LPGI","LPKR","LPPF",
    "LPPS","LTLS","LUCK","LUCY","MAGP","MAHA","MAIN","MAMI","MANG","MAPI","MARI",
    "MARK","MASA","MASB","MAXI","MAYA","MBAP","MBMA","MCAS","MCOR","MDKA","MDLN",
    "MEDC","MEDS","MEGA","MERK","META","MFIN","MFMI","MGLV","MGNA","MGRO","MICE",
    "MIDI","MIKA","MINA","MIRA","MITI","MKAP","MKNT","MKPI","MLBI","MLIA","MLPL",
    "MLPT","MMLP","MNCN","MOLI","MPMX","MPOW","MPPA","MPRO","MRAT","MSIN","MSKY",
    "MTDL","MTEL","MTFN","MTLA","MTMH","MTPS","MTRA","MTSM","MTWI","MYOH","MYOR",
    "MYRX","NAMA","NANO","NATO","NAWI","NAYZ","NCKL","NETV","NFCX","NICE","NICK",
    "NICL","NIKL","NINE","NIPS","NISP","NOBU","NPGF","NRCA","NTBK","NUSA","NZIA",
    "OASA","OBMD","OCAP","OILS","OLIV","OMRE","OPMS","OPPO","PACK","PADA","PALM",
    "PAMG","PANC","PANI","PANR","PANS","PBID","PBRX","PBSA","PCAR","PDES","PDPP",
    "PEGE","PEHA","PEPE","PETS","PGAS","PGLI","PGUN","PICO","PJAA","PKPK","PLAN",
    "PLIN","PMJS","PMMP","PNBN","PNBS","PNGO","PNIN","PNLF","PNSE","POLA","POLI",
    "POLU","POLY","POOL","PORT","POWR","PPGL","PPRE","PPRO","PRAS","PRDA","PRAY",
    "PSAB","PSDN","PSGO","PSKT","PSSI","PTBA","PTDU","PTPP","PTPW","PTRO","PTSN",
    "PTSP","PUDP","PURA","PURE","PURI","PWON","PYFA","PZZA","RAAM","RALS","RANC",
    "RATU","RBMS","RCCC","RDTX","REAL","RICH","RIGS","RIMO","RISE","RMKE","RODA",
    "RONY","ROTI","RSGK","RUIS","RUNS","SAFE","SAMA","SAMF","SAPX","SATU","SBAT",
    "SBI","SCCO","SCNP","SCPI","SDMU","SDPC","SDRA","SEMA","SFAN","SGER","SGRO",
    "SHID","SHIP","SICO","SIDO","SILO","SIMA","SIMP","SINI","SIPD","SKBM","SKRN",
    "SKYB","SLIS","SMDM","SMDR","SMGA","SMGR","SMI","SMIL","SMKL","SMMA","SMMT",
    "SMRA","SMSM","SNLK","SOCI","SOFA","SONA","SOSS","SOTS","SOHO","SPMA","SPTO",
    "SQMI","SRAJ","SRSN","SSIA","SSMS","SSTM","STAR","STTP","SUGI","SULI","SUPR",
    "SURE","SWAT","SWID","TAXI","TBLA","TBMS","TCID","TCPI","TDPM","TEBE","TECH",
    "TELE","TETO","TFAS","TFCO","TGKA","TGRA","TIFA","TIRA","TIRT","TKIM","TLKM",
    "TMPO","TNCA","TOBA","TOTL","TOTO","TOWR","TOYS","TPIA","TPMA","TRAM","TRIL",
    "TRIM","TRIS","TRJA","TRON","TRST","TRUK","TSPC","TUGU","TUNT","TURI","UANG",
    "UCID","UFOE","ULTJ","UNIC","UNIQ","UNIT","UNSP","UNTR","UNVR","URBN","UVCR",
